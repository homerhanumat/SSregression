...
sidebar <- dashboardSidebar(
  sidebarMenu(
    menuItem("Graphs", tabName = "graphs", icon = icon("circle")),
    menuItem("Raw Data", tabName = "data", icon = icon("circle")),
    ...
    tabItem(
      ...
      fluidRow(
        ...
        box(
          ...
          actionButton(
            inputId = "refresh", label = "Simulate New Data",
            icon = icon("refresh")
          )
        ),
        mainPanel(
          ...
          box(
            width = 6, title = "Sums of Squares Graphs",
    ...
    tabItem(
      ...
      fluidRow(
        ...
        box(
          ...
          actionButton(
            inputId = "refresh2", label = "Simulate New Data",
            icon = icon("refresh")
          )
        )
      )
